...
public class Utils {
    ...
    public static IntentFilter makeGattUpdateIntentFilter() {
        ...
        intentFilter.addAction(BtleGattService.ACTION_GATT_CONNECTED);
        intentFilter.addAction(BtleGattService.ACTION_GATT_DISCONNECTED);
        intentFilter.addAction(BtleGattService.ACTION_GATT_SERVICES_DISCOVERED);
        intentFilter.addAction(BtleGattService.ACTION_DATA_AVAILABLE);
